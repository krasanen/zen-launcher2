...
/**
 * Public interface exposed by every Zen Launcher zEventArrayList provider
 */
public interface IProvider {
    ...
    /**
     * Reload the zEventArrayList stored in this provider
     * <p>
     * `"fr.neamar.summon.LOAD_OVER"` will be emitted once the reload is complete. The zEventArrayList provider
     * will stay usable (using it's old zEventArrayList) during the reload.
     */
    void reload();

    /**
     * Indicate whether this provider has already loaded it's zEventArrayList
     * <p>
